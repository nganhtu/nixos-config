...
in
{
  ...
  # Chạy `bootstrap` 1 lần sau clone, khi .env đã có dòng APP_KEY= rỗng
  # và chưa có oauth key trong storage/.
  ...
  # composer install tự động khi vào shell nếu chưa có vendor/.
  enterShell = ''

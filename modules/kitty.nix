...
in
{
  programs.kitty = {
    ...
    extraConfig = ''
      ...
      symbol_map U+3000-U+303F,U+3040-U+30FF,U+3130-U+318F,U+31F0-U+31FF,U+3400-U+4DBF,U+4E00-U+9FFF,U+AC00-U+D7A3,U+F900-U+FAFF,U+FF00-U+FFEF LXGW WenKai Mono
    '';
